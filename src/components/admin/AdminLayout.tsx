...
import {
  LayoutDashboard, CalendarPlus, Route, UserCheck, AlertTriangle,
  Users, Tv, LogOut, Menu, X, ChevronLeft
} from "lucide-react";
...
const AdminLayout = () => {
  ...
  return (
    <div className="min-h-screen flex bg-muted">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-sidebar-background text-sidebar-foreground flex flex-col transition-transform duration-200 lg:translate-x-0 lg:static ${
